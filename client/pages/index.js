            ...
            {proposals && (
              <div className={styles.tabContent}>
                ...
                <div className={styles.widgets}>
                  <Widget info={totalP} title="Proposals Created" style={{ width: "200%" }}>
                    <div className={styles.extraWidgetInfo}>
                      <div className={styles.extraTitle}>Pass Rate</div>
                      <div className={styles.progress}>
                        <div className={styles.progressPercentage} style={{ width: `${passRate}%` }}></div>
                      </div>
                    </div>
                  </Widget>
